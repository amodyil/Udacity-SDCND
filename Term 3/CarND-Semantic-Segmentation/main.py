...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    conv7 = tf.layers.conv2d(vgg_layer7_out, 
                             ...
                             1, 
                             padding = 'same', 
                             kernel_initializer=tf.random_normal_initializer(stddev=kernel_initializer),
                             kernel_regularizer=tf.contrib.layers.l2_regularizer(kernel_regularizer))   
    out = tf.layers.conv2d_transpose(conv7, 
                                     num_classes, 
                                     4, 
                                     2, 
                                     padding = 'same', 
    ...
    out = tf.layers.conv2d_transpose(out, 
                                     num_classes, 
                                     4, 
                                     2, 
                                     padding = 'same', 
